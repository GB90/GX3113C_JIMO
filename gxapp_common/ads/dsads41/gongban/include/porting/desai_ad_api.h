...
#define DSAD_OSD_DISPLAY_MAX_NUMBER (30)
#else
#define DSAD_OSD_DISPLAY_MAX_NUMBER (15)
#endif
...
{
	ST_DSAD_OSD_SHOW_INFO stTextShow[DSAD_OSD_DISPLAY_MAX_NUMBER ];	
	UINT8 aucFlag[DSAD_OSD_DISPLAY_MAX_NUMBER ];
	UINT8 ucOsdNum;
...
#ifdef DVB_AD_TYPE_DS_FLAG41
void DSAD_SendProgram(ST_DSAD_PROGRAM_PARA stProgramPara);
void DSAD_SendShowOSDNum(UINT16 ucNo);
#endif
