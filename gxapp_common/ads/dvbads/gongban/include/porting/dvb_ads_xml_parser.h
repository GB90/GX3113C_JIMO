#ifndef ADS_XML_PARSER_H__
#define ADS_XML_PARSER_H__
...
typedef struct _Data_Node{
	u8 *p_ads_pic_data;	//save the data of the pic 
	ads_pic_attribute ads_pic_attribute_data;	 //save the xml info of this pic
	ads_pic_infomation p_pic_info;			//save the pic info of this pic
	u16 text_size;		//
	enum data_status_e status;	//save complete or not
	struct _Data_Node *next;		//pointed to the next pic saving node
}ads_data_node;
