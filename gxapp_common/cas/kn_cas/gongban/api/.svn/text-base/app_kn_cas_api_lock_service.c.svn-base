...
void app_kn_cas_api_lock_service(BU16 wOriNetID,BU16 wTSID,BU16 wServiceID,BU8 *pUTCTime)
{
	/*
	...
	* 根据逻辑频道号获取节目索引
	*/
	if (TRUE != app_lcn_list_get_prog_pos(serviceIndex,&pos))
	{
		printf("app_by_cas_api_lock_service app_get_prog_pos_by_LCN fail\n");
		return;						
	}
	...
	app_kn_cas_api_set_lock_status(TRUE);
	return;	
}
