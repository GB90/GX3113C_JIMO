 ...
 *
 */
#ifndef __APP_kn_CAS_API_DEMUX_H__
#define __APP_kn_CAS_API_DEMUX_H__
#ifdef __cplusplus
extern "C" {
#endif

#include "app_common_play.h"
int app_kn_cas_api_bat_filter_open(void);
handle_t app_kn_cas_api_bat_get_filter_handle(void);
handle_t app_kn_cas_api_bat_get_channel_handle(void);
uint8_t	app_kn_cas_api_release_bat_filter(void);
...
bool        app_kn_cas_api_check_pmt_ca_descriptor_valid(uint8_t *sectionData,uint32_t CA_system_id);
 void       app_kn_cas_api_create_filter_time_out_task(void);
 ...
 void app_kn_cas_api_bat_filter_notify(handle_t Filter, const uint8_t* Section, size_t Size);
 void app_kn_cas_filter_timeout_notify(handle_t Filter, const uint8_t* Section, size_t Size);

#ifdef __cplusplus
}
#endif
#endif /*__APP_kn_CAS_API_DEMUX_H__*/
