...
/*用DVTCA_VERSION_NITAREALOCK宏来区分有无nit方式的区域锁定.由数码视讯人员控制。2009-12-14
  如果定义了此宏，表示有nit方式的区域锁定，就多了DVTSTBCA_GetNitValue接口需要机顶盒实现.
*/
#define	DVTCA_VERSION_NITAREALOCK	//如果有nit区域锁定，需要定义；否则，注释掉此行?????????????
...
#define DVTCA_SWTICH_CHANNEL					22			
