...
#define 	CA_MAX_PRODUCT_NAME_LENGTH		16 /* 产品包名称最大长度 */ 
...
typedef struct _T_CA_EntitleInfo
{
	...
	GYU8	m_bVideoRecordEnabled; /* 是否可录像. 备用.*/
	GYU8 	m_byComeFrom; /* 0-智能卡授权, 1-集团授权, 2-主卡授权. 备用*/
	GYU8	m_szProductName[CA_MAX_PRODUCT_NAME_LENGTH]; /*产品包名称*/
	GYU8	m_byValidFlag; /* 此产品包授权当前是否有效, 用于区分历史授权记录*/ 
	T_CA_Date 	m_startDate; /*产品包授权开始时间*/
	T_CA_Date  	m_expireDate; /*过期日期*/
}T_CA_EntitleInfo;
...
typedef enum
{
	...
	GYCA_ENTITLEMENT_CHANGED,  /*授权变化通知消息*/
	GYCA_SMC_STATUS, 		/* 智能卡状态已改变*/ 
}GYCA_MSG_TYPE;
