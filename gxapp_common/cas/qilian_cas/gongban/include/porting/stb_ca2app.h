...
参数:  当前节目的pmtpid，节目序号
--*/
//void STBCA_SetCurChannelInfo(BU16 Pmtpid,BU16 serverid);
/*++
...
/*++
功能：调用CAS模块，demux停止请求section数据，如果想恢复可调用STBCA_SetCurChannelInfo
参数：void	
*/
...
/*
功能：调用CAS模块，设置存储序号为saveNO 的邮件为已读
返回：0 表示读取失败，或者邮件不存在。
*/
