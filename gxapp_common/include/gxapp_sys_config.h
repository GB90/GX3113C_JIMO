...
#define DVB_CA_DV DVB_CA_TYPE_DSCAS50
#define DVB_CA_TYPE_DS_CAS50_FLAG
  
  
#define  DVB_AD_TYPE_DS_FLAG
#define USB_FLAG 
#define CUST_JIMO
...
#define DVB_ZOOM_RESTART_PLAY 1
