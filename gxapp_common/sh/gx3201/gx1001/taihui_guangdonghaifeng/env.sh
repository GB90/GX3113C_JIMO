...
export DVB_MARKET=taihui_guangdong_haifeng
...
export DVB_PANEL_TYPE=PANEL_TYPE_fd650_TAIHUI_NEW
...
export DVB_LOGO_JPG=logo_taihui_haifeng.jpg
if [ "$1" = "csky-linux" ] ; then
# XML、图片等路径
...
echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/taihui_quanzhi/development
