...
if [ $DVB_CA_FLAG = "yes" ]; then
	#CA枚举（与app_common_porting_stb_api.h中dvb_ca_type_t结构体中对应）
	export DVB_CA_TYPE=DVB_CA_TYPE_GY
	export DVB_CA_1_NAME=gy_cas
	export DVB_CA_1_LIB=gyca30_20140328
	export DVB_CA_1_FLAG=DVB_CA_TYPE_GY_CAS_FLAG
fi
