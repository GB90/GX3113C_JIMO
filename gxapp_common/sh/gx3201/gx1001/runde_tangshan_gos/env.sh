...
export DVB_MARKET=runde_tangshan_gos
...
if [ $DVB_CA_FLAG = "yes" ]; then
	#CA枚举（与app_common_porting_stb_api.h中dvb_ca_type_t结构体中对应）
	export DVB_CA_TYPE=DVB_CA_TYPE_GOS
    export DVB_CA_1_NAME=gos_cas
    export DVB_CA_1_LIB=gosca
    export DVB_CA_1_FLAG=DVB_CA_TYPE_GOS_FLAG
fi
...
export DVB_LOGO_JPG=logo_tangshan_139_gosCA.jpg
if [ "$1" = "csky-linux" ] ; then
# XML、图片等路径
...
echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/runde_tangshan_sanzhou
