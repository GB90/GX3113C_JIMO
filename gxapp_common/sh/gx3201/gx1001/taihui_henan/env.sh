...
export GX_KERNEL_PATH=$GXSRC_PATH/../../v1.9.2/linux-2.6.27.55
...
export DVB_MARKET=taihui_henan
...
export DVB_LOGO_JPG=logo_taihui_henan_203.jpg
...
echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/taihui_quanzhi
