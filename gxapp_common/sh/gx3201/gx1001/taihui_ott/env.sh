...
if [ $DVB_CA_FLAG = "yes" ]; then
    ...
    export DVB_CA_1_LIB=Y1125-taihui-GX3201-20140521
...
export DVB_PANEL_TYPE=PANEL_TYPE_fd650_TAIHUI
...
export DVB_KEY_TYPE=KEY_HUNAN_TAIHUI_NEW
# demod type 
...
echo SVN PATH:
	...
	echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/runde_ott
