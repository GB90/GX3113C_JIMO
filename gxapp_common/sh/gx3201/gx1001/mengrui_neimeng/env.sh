...
export RC_VERSION=GOXCEED_v1_9_RELEASE
...
export DVB_MARKET=mengrui_neimeng
...
export DVB_KEY_TYPE=KEY_NEIMENG_CABLE
...
export DVB_LCN_DEFAULT=0
export DVB_CENTER_FRE=235
...
echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/neimeng/development
...
echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/neimeng/gxota
