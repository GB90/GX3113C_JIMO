...
export DVB_MARKET=runde_guangxi_yulin
...
if [ $DVB_CA_FLAG = "yes" ]; then
    ...
    export DVB_CA_1_NAME=xinshimao_cas
...
# set ad support type
export DVB_AD_NAME=xinshimaoads
export DVB_AD_FLAG=DVB_AD_TYPE_XINSHIMAO_FLAG
export DVB_AD_LIB=ad
...
export DVB_TUNER_TYPE=53

#已支持开机画面图片，参考：logo_jpg目录下的图片
export DVB_LOGO_JPG=logo_guangxi_yulin.jpg
if [ "$1" = "csky-linux" ] ; then
# XML、图片等路径
...
echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/runde_guangxi_yulin/development
echo  https://isvn.guoxintech.com/svn/3201_DVBC/demod
echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/runde_guangxi_yulin/gxloader
