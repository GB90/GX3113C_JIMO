...
export RC_VERSION=GOXCEED_v1_9_2
export GXLIB_PATH=/opt/goxceed/$CROSS_PATH
export GXSRC_PATH=`pwd`
#export GX_KERNEL_PATH=$GXSRC_PATH/../linux-2.6.27.55
#export GX_KERNEL_PATH=$GXSRC_PATH/../../v1.9.1-1/linux-2.6.27.55
export GX_KERNEL_PATH=/home/cth/work/gx3201/rc7_1213/v1.9.2/linux-2.6.27.55
#export GX_KERNEL_PATH=/home/cth/work/gx3201/OTT/linux-2.6.27.55
...
if [ $DVB_CA_FLAG = "yes" ]; then
	#CA枚举（与app_common_porting_stb_api.h中dvb_ca_type_t结构体中对应）
    export DVB_CA_TYPE=DVB_CA_TYPE_KN
    export DVB_CA_1_NAME=kn_cas
    export DVB_CA_1_LIB=knca
    export DVB_CA_1_FLAG=DVB_CA_TYPE_KN_FLAG
fi
...
#export AUDIO_DOLBY=yes #for 3201D
export AUDIO_DOLBY=no #for 3201
...
export DVB_PANEL_TYPE=PANEL_TYPE_fd650_KENENG
...
export DVB_KEY_TYPE=KEY_YUENAN_KENENG_NEW
# demod type 
...
export DVB_TUNER_TYPE=60 #18250a
#export DVB_TUNER_TYPE=53 #18250



#已支持开机画面图片，参考：logo_jpg目录下的图片
export DVB_LOGO_JPG=logo_keneng_jiazi.jpg
...
#export DVB_CENTER_FRE=171
export DVB_CENTER_FRE=474
...
echo SVN PATH:
	...
	echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/kn_ott
	echo  https://isvn.guoxintech.com/svn/3201_DVBC/demod_svn786
