...
export RC_VERSION=GOXCEED_v1_9_3_3
...
if [ $DVB_CA_FLAG = "yes" ]; then
	#CA枚举（与app_common_porting_stb_api.h中dvb_ca_type_t结构体中对应）
#    export DVB_CA_TYPE=DVB_CA_TYPE_XINSHIMAO
#    export DVB_CA_1_NAME=xinshimaoca
#    export DVB_CA_1_LIB=ca
#    export DVB_CA_1_FLAG=DVB_CA_TYPE_XINSHIMAO_FLAG

#	export DVB_CA_TYPE=DVB_CA_TYPE_DSCAS50
#	export DVB_CA_1_NAME=desaicas5.0
#	export DVB_CA_1_LIB=ca
#	export DVB_CA_1_FLAG=DVB_CA_TYPE_DS_CAS50_FLAG	

#	export DVB_CA_TYPE=DVB_CA_TYPE_BY
#	export DVB_CA_1_NAME=byca
#	export DVB_CA_1_LIB=byca
#	export DVB_CA_1_FLAG=DVB_CA_TYPE_BY_FLAG

#	export DVB_CA_TYPE=DVB_CA_TYPE_QILIAN
#	export DVB_CA_1_NAME=qilianca
#	export DVB_CA_1_LIB=qilianca
#	export DVB_CA_1_FLAG=DVB_CA_TYPE_QILIAN_FLAG
...
#	export DVB_CA_1_FLAG=DVB_CA_TYPE_MG_FLAG
    ...
    export DVB_CA_1_LIB=dvt20140531
    export DVB_CA_1_FLAG=DVB_CA_TYPE_DVT_FLAG

#	export DVB_CA_TYPE=DVB_CA_TYPE_DIVITONE
#	export DVB_CA_1_NAME=divitoneca
#	export DVB_CA_1_LIB=DiviGuardCalib-Guoxin-GX3201-debug-20130926-new2
...
export DVB_KEY_TYPE=KEY_GONGBAN_NATIONALCHIP_NEW

# demod type 
export DVB_DEMOD_TYPE=DVB_DEMOD_GX1503
...
#	echo DVB_CENTER_QAM=$DVB_CENTER_QAM
    ...
    echo DVB_32MB=$DVB_32MB
	echo DVB_FLASH=$DVB_FLASH
fi
echo SVN PATH:
