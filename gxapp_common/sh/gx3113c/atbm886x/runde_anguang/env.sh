...
export RC_VERSION=GOXCEED_v1_9_3_1
...
export DVB_MARKET=runde_anguang
...
if [ $DVB_CA_FLAG = "yes" ]; then
    ...
    export DVB_CA_TYPE=DVB_CA_TYPE_KP
    export DVB_CA_1_NAME=kp_cas
    export DVB_CA_1_LIB=KPlus-GX3113C-debug-20141222
    export DVB_CA_1_FLAG=DVB_CA_TYPE_KP_FLAG
...
export DVB_PANEL_TYPE=PANEL_TYPE_CT1642_HAIXIN
...
export DVB_LOGO_JPG=logo_anhui.jpg
if [ "$1" = "csky-linux" ] ; then
# XML、图片等路径
