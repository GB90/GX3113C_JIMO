...
export DVB_MARKET=zhiling_gongban
...
export DVB_PANEL_TYPE=PANEL_TYPE_fd650_ZHILING
...
export DVB_KEY_TYPE=KEY_ZHILING_NEW
...
export DVB_LOGO_JPG=logo_ziling_thunderstorm.jpg
if [ "$1" = "csky-linux" ] ; then
# XML、图片等路径
...
if [ "$1" = "csky-ecos" ] ; then
# 广播背景图片路径
export DVB_LOGO_PATH='"/theme/logo_startup.bin"'
