...
export DVB_MARKET=runde_huixian_sanzhou
...
#if [ $DVB_CA_FLAG = "yes" ]; then
#	export DVB_CA_2_NAME=wf_cas
#	export DVB_CA_2_LIB=wfcas21gx3201
#	export DVB_CA_2_FLAG=DVB_CA_TYPE_WF_CA_FLAG
#fi
...
#export DVB_LOGO_JPG=logo_runde_henan_pingdingsan.jpg
export DVB_LOGO_JPG=logo_runde_henan_huixian.jpg
...
#音视频同步方式 0-PCR_RECOVER  3-AVPTS_RECOVER 
...
export DVB_CENTER_FRE=610
#export DVB_CENTER_FRE=618
...
echo  https://isvn.guoxintech.com/svn/3201_DVBC/market/runde_henan_sanzhou/development
