...
int panel_fd =  -1;
int32_t app_goxceed_printf(int32_t ver)
{
	switch(ver)
		{
			case GOXCEED_v1_9_RELEASE:
				printf("goxceed version is goxceed-v1.9-RELEASE\n");
				break;
			case GOXCEED_v1_9_1:
				printf("goxceed version is goxceed-v1.9.1\n");
				break;
			case GOXCEED_v1_9_1_1:
				printf("goxceed version is goxceed-v1.9.1_1\n");
				break;
			case GOXCEED_v1_9_2:
				printf("goxceed version is goxceed-v1.9.2\n");
				break;
			case GOXCEED_v1_9_3:
				printf("goxceed version is goxceed-v1.9.3\n");
				break;
			case GOXCEED_v1_9_3_1:
				printf("goxceed version is goxceed-v1.9.3_1\n");
				break;	
		case GOXCEED_v1_9_3_4:
			printf("goxceed version is goxceed-v1.9.3_4\n");
			break;		
		case GOXCEED_v1_9_4:
			printf("goxceed version is goxceed-v1.9.4\n");
			break;	
		case GOXCEED_v1_9_5:
			printf("goxceed version is goxceed-v1.9.5\n");
			break;		
		default:
			printf("goxceed version is unknow\n");
			break;
	}
	return 0;
...
//	GxBus_ConfigSetInt(FRONTEND_CONFIG_WATCH_TIME,FRONT_MONITER_DURATION);
	 ...
	 */
	#ifdef APP_HD
	VideoInterface = VIDEO_OUTPUT_HDMI|VIDEO_OUTPUT_RCA1;
	#endif
	#ifdef APP_SD
...
void app_sys_init(void)
{
	...
	/* 串口输出gxapp_common 的SVN版本*/
#ifdef APP_COMMON_SVN
