...
__BEGIN_DECLS
     ...
     */ 
    size_t      GxCA_NvramRead          (uint32_t       Offset, 
                                         uint8_t*       Buf, 
                                         size_t         BufSize );
    /**
     * @brief       NVRAM写接口   
     ...
     * @see 
     */ 
    size_t      GxCA_NvramWrite         (uint32_t       Offset, 
                                        const uint8_t*  Data, 
                                        size_t          DataSize );
    /**
     * @brief       NVRAM清除接口   
     ...
     * @see 
     */ 
    void        GXCA_NvramClean         (uint32_t       Offset, 
                                        size_t          Len );
    /**
     * @brief       NVRAM信息获取接口  
     ...
     * @see 
     */ 
    void        GxCA_NvramGet           (uint32_t*      StartOffset, 
                                        size_t*         Len );
    /**
     * @brief       NVRAM获取STB ID    
     * @param       无
