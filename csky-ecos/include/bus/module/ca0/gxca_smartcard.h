 ...
 */
handle_t    GxCA_SmartcardOpen      (const char*            name,
                                     GxCA_SmartParams*      param);
 ...
 */                                    
int         GxCA_SmartcardReset     (handle_t           handle, 
                                     uint8_t*           AtrBuf, 
                                     size_t             BufSize);
 ...
 */ 
int         GxCA_SmartcardConfig    (handle_t                       handle, 
                                     const GxCA_SmartTimeParams*    time);
 ...
 */
int         GxCA_SmartcardSendCmd   (handle_t           handle, 
                                     const uint8_t*     Cmd, 
                                     size_t             CmdLen);
/**
 * @brief       获取智能卡响应
 ...
 */
int         GxCA_SmartcardGetReply  (handle_t           handle, 
                                     uint8_t*           ReplyBuf, 
                                     size_t             BufSize);
/**
 * @brief       关闭智能卡
