...
__BEGIN_DECLS
     ...
     * @see 
     */                                            
    bool        GxCA_DescramblerSetStreamPID     (handle_t      Descrambler, 
                                                 uint16_t       PID);

    int16_t     GxCA_DescramblerGetStreamPid     (handle_t Descrambler);


    bool        GxCA_DescramblerSetEcmPID        (handle_t Descrambler, 
                                                 uint16_t  EcmPID);
     ...
     * @see 
     */                                            
    bool        GxCA_DescramblerSetOddKey       (handle_t       Descrambler, 
                                                uint8_t*        OddKey, 
                                                size_t          KeyLen);
    /**
     * @brief       设置偶密钥到解挠器   
     ...
     * @see 
     */                                            
    bool        GxCA_DescramblerSetEvenKey      ( handle_t      Descrambler, 
                                                uint8_t*        EvenKey, 
                                               size_t          KeyLen);
#endif
...
void GxCA_DescramblerSetOddECW(handle_t Descrambler,
    ...
    int         GxCA_DescramblerGetByEcmPid     (uint16_t        EcmPID,
                                                 handle_t*       Buf,
                                                 size_t          num);
