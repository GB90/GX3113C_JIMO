...
__BEGIN_DECLS
     ...
     */
    void        GxCA_DemuxInit                      (uint8_t Prior, 
                                                     uint32_t TotalChannelNum, 
                                                     uint32_t TotalFitlerNum);
     ...
     * @see ::GxCA_DemuxChannelFree ::GxCA_DemuxChannelSetPID
     */
    handle_t    GxCA_DemuxChannelAllocate           (uint32_t       DemuxID,
                                                     int16_t        PID,bool repeatFlag);
    /**
     * @brief       释放一个Channel
     ...
     */                                                                
    bool        GxCA_DemuxChannelSetPID             (handle_t       Channel, 
                                                    uint16_t        PID,bool repeatFlag);
     ...
     * @see
     */                                                                
    handle_t    GxCA_DemuxFilterAllocate            (handle_t       Channel,
                                                     uint8_t        ID);
    /**
     ...
     * @see
     */                                                 
    handle_t    GxCA_DemuxFilterGetByID             (handle_t       Channel, 
                                                     uint8_t        ID);
    /**
     ...
     */
    bool        GxCA_DemuxFilterRigsterNotify       (handle_t       Filter,
                                                     FilterNotify   Callback,
                                                     FilterTimeOut  TimeOutCallback);
