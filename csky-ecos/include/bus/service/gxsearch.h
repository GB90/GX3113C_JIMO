...
typedef enum { GX_SEARCH_AUTO = 0,	///< auto搜索
	GX_SEARCH_MANUAL,	///< manual搜索
	GX_SEARCH_PID,	///< pid搜索
} GxSearchType;
typedef enum { GX_SEARCH_NIT_ENABLE = 0,	///< nit搜索使能
...
typedef enum { GX_SEARCH_TV = 1,	///<只搜索TV节目
...
typedef enum { GX_SEARCH_FTA = 1,	///<只搜索免费节目
