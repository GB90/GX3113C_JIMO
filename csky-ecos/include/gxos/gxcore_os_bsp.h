...
#define CODEC_AC3(chip)         FIRM_CLASS(chip, ac3       )
...
#define CODEC_DOLBY51(chip)     FIRM_CLASS(chip, dolby51   )
#define CODEC_DOLBY71(chip)     FIRM_CLASS(chip, dolby71   )
#define CODEC_DOLBYDCV(chip)    FIRM_CLASS(chip, dolbydcv  )
...
#define MOD_AV(p)             cyg_av_init_class                av0(p)          CYGBLD_ATTRIB_INIT_PRI( 60500 );
