...
// ---------------------------------------------------------------------------
extern int mkfs_mbr_dpt_update(const char *name, char *fsname);
__externC int cyg_fileio_part_info(const char *dev_name, int part_num,
		struct cyg_disk_part_info_t *part, int *act_part_num);
// ---------------------------------------------------------------------------
