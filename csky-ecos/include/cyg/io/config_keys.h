...
#define CYG_IO_GET_CONFIG_FLASH_INFO              0x609

/* Spi Flash OTP function */
#define CYG_IO_SET_CONFIG_FLASH_OTP_LOCK          0x610
#define CYG_IO_GET_CONFIG_FLASH_OTP_STATUS        0x611
#define CYG_IO_SET_CONFIG_FLASH_OTP_ERASE         0x612
#define CYG_IO_GET_CONFIG_FLASH_OTP_GET_REGION    0x613
#define CYG_IO_SET_CONFIG_FLASH_OTP_SET_REGION    0x614
#define CYG_IO_GET_CONFIG_FLASH_OTP_READ          0x615
#define CYG_IO_SET_CONFIG_FLASH_OTP_WRITE         0x616

/* Spi Flash XIP function */
#define CYG_IO_SET_CONFIG_FLASH_XIP_ENTER         0x620
#define CYG_IO_SET_CONFIG_FLASH_XIP_EXIT          0x621

/* Spi Flash other function */
#define CYG_IO_SET_CONFIG_FLASH_SYNC              0x630
...
#define CYG_IO_SET_CONFIG_USB_WIFI                0x706
