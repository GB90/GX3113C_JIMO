...
typedef struct {
    ...
    Cyg_ErrNo (*set_config)(cyg_io_handle_t handle, 
                            ...
                            const void *buf, 
                            cyg_uint32 *len);
    Cyg_ErrNo (*ioctl)(cyg_io_handle_t handle,  //modified by gxcoreapi 
                            cyg_uint32 key, 		
                            void *buf);
    Cyg_ErrNo (*close)(cyg_io_handle_t handle);  //modified by gxcoreapi 	
	CYG_ADDRWORD (*mmap)(cyg_io_handle_t handle, CYG_ADDRWORD data, int len);   //modified by gxcoreapi 	
} cyg_devio_table_t;
...
//gxcoreapi modified start
__externC CYG_ADDRWORD cyg_devio_mmap(cyg_io_handle_t handle, CYG_ADDRWORD data, int len);

__externC Cyg_ErrNo cyg_devio_ioctl(cyg_io_handle_t handle, cyg_uint32 key, const void *buf);

__externC Cyg_ErrNo cyg_devio_close(cyg_io_handle_t handle);
//gxcoreapi modified end
...
typedef struct cyg_devtab_entry {
    ...
    cyg_bool         (*init)(struct cyg_devtab_entry *tab);
...
#define CYG_DEVTAB_STATUS_EMPTY   0x4000

extern cyg_devtab_entry_t __DEVTAB__[], __DEVTAB_END__;
//gxcoreapi modifed start
