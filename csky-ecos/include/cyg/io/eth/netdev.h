...
typedef struct cyg_netdevtab_entry {
    const char        *name;
    cyg_bool             (*init)(struct cyg_netdevtab_entry *tab);
...
static cyg_bool _init(struct cyg_netdevtab_entry *tab);                  \
...
//================add by gaohb====================>>
#define CYG_NETDEVTAB_STATUS_EMPTY   0x0010

#define EMPTY_NETDEVTAB_ENTRY(_l)  									\
cyg_netdevtab_entry_t _l CYG_HAL_TABLE_ENTRY(netdev)= {     		\
   0,                              									\
   0,                             									\
   0,                             									\
   CYG_NETDEVTAB_STATUS_EMPTY    									\
};
//================add by gaohb====================<<
#endif // _NETDEV_H_
