...
typedef enum {
	...
	COLLATION_NTOFS_END = const_cpu_to_le32(0xffffffff),
} COLLATION_RULES;
...
typedef enum {
	...
	ATTR_DEF_ALWAYS_LOG = const_cpu_to_le32(0x80),	/* Always log
							   ...
							   resident. */
	ATTR_DEF_END = const_cpu_to_le32(0xffffffff),
} ATTR_DEF_FLAGS;
 ...
 * attributes.
 */
			/* 36 */ u32 maximum_versions;
			/* Maximum allowed versions for
			   file. Zero if version numbering is disabled. */
			/* 40 */ u32 version_number;
...
/*  0	ACE_HEADER; -- Unfolded here as gcc doesn't like unnamed structs. */
	...
	/*  4 */ ACCESS_MASK mask;
	/* Access mask associated with the ACE. */
	/*  8 */ OBJECT_ACE_FLAGS object_flags;
...
/* 28*/ GUID inherited_object_type;
    ...
    ACCESS_DENIED_OBJECT_ACE, SYSTEM_AUDIT_OBJECT_ACE, SYSTEM_ALARM_OBJECT_ACE;
...
/*  0	SECURITY_DESCRIPTOR_HEADER; -- Unfolded here as gcc doesn't like
	...
	u64 offset;		/* Byte offset of this entry in the $SDS stream. */
	u32 length;		/* Size in bytes of this entry in $SDS stream. */
	/* 20 */ SECURITY_DESCRIPTOR_RELATIVE sid;
...
typedef struct {
	...
	/*  4 */ u32 collation_rule;
	/* Collation rule used to sort the
	   index entries. If type is $FILE_NAME,
	   this must be COLLATION_FILE_NAME. */
	/*  8 */ u32 index_block_size;
...
typedef struct {
	...
	union {
		...
		struct {
			/* 12 */ u32 cert_thumbprint_header_size;
			/* Size in
			   bytes of the header of the certificate
			   thumbprint. */
			/* 16 */ u32 cert_thumbprint_header_offset;
			/* Offset in
