...
/*Ofs*/
	...
	/* Usable byte size of the log file.  If the
	   ...
	   log record pages. */
	/* 32 */ le32 last_lsn_data_length;
	/* Length of data of last LSN, not including
	   the log record header.  On create set to
	   0. */
	/* 36 */ le16 log_record_header_length;
