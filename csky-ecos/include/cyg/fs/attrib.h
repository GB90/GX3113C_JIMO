...
extern int ntfs_attr_position(const ATTR_TYPES type,
...
extern void ntfs_attr_init(ntfs_attr * na, const BOOL non_resident,
			   const BOOL compressed, const BOOL encrypted,
			   const BOOL sparse, const s64 allocated_size,
			   const s64 data_size, const s64 initialized_size,
...
extern int ntfs_attr_record_resize(MFT_RECORD * m, ATTR_RECORD * a,
				   u32 new_size);
