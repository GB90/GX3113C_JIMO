...
#if defined(CYGPKG_HAL_CK_MSBFIRST)
# define CYG_BYTEORDER           CYG_MSBFIRST    // Big endian
#elif defined(CYGPKG_HAL_CK_LSBFIRST)
# define CYG_BYTEORDER           CYG_LSBFIRST    // Little endian
#else
# error CK endianess not defined by configuration
#endif

#if defined(CYGPKG_HAL_CK_DOUBLE_MSBFIRST)
# define CYG_DOUBLE_BYTEORDER    CYG_MSBFIRST    // Big endian
#elif defined(CYGPKG_HAL_CK_DOUBLE_LSBFIRST)
...
//-----------------------------------------------------------------------------
// CK does not usually use labels with undersores.
...
// The CK architecture uses the default definitions of the base types,
