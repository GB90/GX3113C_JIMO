#ifndef CYGONCE_HAL_CK_STUB_H
#define CYGONCE_HAL_CK_STUB_H
//========================================================================
//
//      ck-stub.h
//
//      CK-specific definitions for generic stub
//
//========================================================================
...
// Date:          1998-06-08
// Purpose:       
// Description:   CK-specific definitions for generic stub
// Usage:         
//
//####DESCRIPTIONEND####
//
...
#if defined(CYGPKG_HAL_CK_GDB_REPORT_CP0)
#define NUMREGS   107
#else
#define NUMREGS    90
#endif
...
# ifdef CYGINT_HAL_CK_STUB_REPRESENT_32BIT_AS_64BIT
#  error __ck64 & CYGINT_HAL_CK_STUB_REPRESENT_32BIT_AS_64BIT
# endif

#elif defined(CYGINT_HAL_CK_STUB_REPRESENT_32BIT_AS_64BIT)
...
#define CYGARC_SIGN_EXTEND_REGISTERS
    ...
    // get modified to implement CYGINT_HAL_CK_STUB_REPRESENT_32BIT_AS_64BIT

#elif defined(CYGPKG_HAL_CK_VR4300)
  // Even though we are only working with 32 bit registers, GDB expects 64 bits
  #define REGSIZE(X) 8
  typedef unsigned long long target_register_t;
  // We need to sign-extend the registers so GDB doesn't get confused.
  #define CYGARC_SIGN_EXTEND_REGISTERS
#elif 0 // defined(CYGPKG_HAL_CK_TX49)
  // Even though we are only working with 32 bit registers, GDB expects 64 bits
  #define REGSIZE(X) 8
  typedef unsigned long target_register_t;
  ...
  // We need to sign-extend the registers so GDB doesn't get confused.
  #define CYGARC_SIGN_EXTEND_REGISTERS
#elif defined(CYGPKG_HAL_CK_RM7000)
  // Even though we are only working with 32 bit registers, GDB expects 64 bits
  #define REGSIZE(X) 8
  typedef unsigned long target_register_t;
  ...
  // We need to sign-extend the registers so GDB doesn't get confused.
  #define CYGARC_SIGN_EXTEND_REGISTERS
#elif 0 //defined(CYGPKG_HAL_CK_CK32)
  // Even though we are only working with 32 bit registers, GDB expects 64 bits
  #define REGSIZE(X) 8
  typedef unsigned long target_register_t;
...
#endif // ifndef CYGONCE_HAL_CK_STUB_H
