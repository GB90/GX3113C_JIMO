#ifndef CYGONCE_HAL_CK_REGS_H
#define CYGONCE_HAL_CK_REGS_H
//========================================================================
//
//      ck-regs.h
//
//      Register defines for CK processors
//
//========================================================================
...
// Date:          1998-06-08
// Purpose:       
// Description:   Register defines for CK processors
// Usage:         
//
//####DESCRIPTIONEND####
//
...
/* This value must agree with NUMREGS in ck-stub.h. */
...
/* CK registers, numbered in the order in which gdb expects to see them. */
#define ZERO            0
#define AT              1
#define ATMP            1
#define V0              2
...
#define SR_SX           0x00000040      /* ck3 & xtlb in supervisor mode */
#define SR_UX           0x00000020      /* ck3 & xtlb in user mode */
...
#endif // ifndef CYGONCE_HAL_CK_REGS_H
