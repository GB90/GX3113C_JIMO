...
#define UNKOWNFILESYSTEM 203   /* Unknown filesystem  */  
#define EINITERR	     204   /* the device init error*/
#define EFR_INVALID_NAME 205   /* the invalid file name */
#define EPARTITION_NUM   206   /* the disk partition num is wrong */
