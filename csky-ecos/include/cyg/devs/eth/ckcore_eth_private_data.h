#ifndef _CKCORE_PRIVATE_DATA_H_
#define _CKCORE_PRIVATE_DATA_H_
//==========================================================================
...
struct ckcore_eth_priv_data_t
{
    ...
    uint32   txkey[NUM_TXBDS];
    /*   Temporary packet buffer.                                           */

    eth_frame_hdr pkt_buf;

};
typedef struct ckcore_eth_priv_data_t ckcore_eth_priv_data_t;

#define PCKCORE_ETH_DATA(_SC_) \
    ((ckcore_eth_priv_data_t*)(((struct eth_drv_sc*)(_SC_))->driver_private))
#define PBUF_INFO(_SC_) \
    (&(((ckcore_eth_priv_data_t*)((_SC_)->driver_private))->nbuffer))
