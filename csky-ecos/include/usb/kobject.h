...
enum kobject_action {
        KOBJ_ADD        = (kobject_action_t) 0x01,      /* exclusive to core */
        KOBJ_REMOVE     = (kobject_action_t) 0x02,      /* exclusive to core */
        KOBJ_CHANGE     = (kobject_action_t) 0x03,      /* device state change */
        KOBJ_OFFLINE    = (kobject_action_t) 0x04,      /* device offline */
        KOBJ_ONLINE     = (kobject_action_t) 0x05,      /* device online */
        KOBJ_MOVE       = (kobject_action_t) 0x06,      /* device move */
};
...
extern char * kobject_get_path(struct kobject *);
...
extern int  subsystem_register(struct kset *);
