#ifndef CYGONCE_ISO_SYS_MMAN_H
#define CYGONCE_ISO_SYS_MMAN_H
/*========================================================================
//
//      sys/time.h
//
...
void *mmap __P((void *, size_t , int , int , int , off_t));  //gxcoreapi modified
int munmap __P((void *, size_t));              //gxcoreapi modified
