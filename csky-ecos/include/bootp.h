...
__externC int net_ifconfig(char *if_name,char *cmd,char *argument);
__externC void network_init(char *if_name);
__externC int network_dhcp(char *if_name);
__externC int network_down(char *if_name);
__externC void network_dhcp_release(char *if_name);
__externC int getdns(char *if_name,struct in_addr *gateway,struct in_addr *dnsA,struct in_addr *dnsB);
__externC int getip(char *if_name,unsigned int *ip, unsigned int *mask, unsigned char *mac);
