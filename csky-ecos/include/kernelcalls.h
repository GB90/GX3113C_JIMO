...
#define gx_time_delay_us(d)              cyg_time_delay_us(d)
#define gx_mdelay(n)                     gx_time_delay_us((n)*1000)
#define gx_udelay(n)                     gx_time_delay_us(n)
#define gx_msleep(n)                     gx_time_delay_us((n)*1000)
int	gx_gettimeofday(struct timeval *tv, struct timezone *tz);
...
#define gx_mutex_init(m)
#define gx_mutex_lock(m)
#define gx_mutex_unlock(m)
...
extern int gxav_profile_init(char* profile);
extern int gxav_get_enable_nds(void);
