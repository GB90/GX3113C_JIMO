...
typedef enum {
	...
	GxVideoDecoderPropertyID_CoverFrame       = 2015,
...
typedef enum {
	...
	GxVideoOutPropertyID_DisableHDCP          = 7019,
	GxVideoOutPropertyID_StartHDCP            = 7020,
...
typedef enum {
	...
	GxICAMPropertyID_M2M_UpdateKey            = 20022,
	GxICAMPropertyID_M2M_SetParamsAndExecute  = 20023,
	GxICAMPropertyID_M2M_Event                = 20024
} GxICAMPropertyID;
...
typedef enum {
	GxMTCPropertyID_Config                    = 40001,
	GxMTCPropertyID_Run                       = 40002,
	GxMTCPropertyID_Reset                     = 40003
} GxMTCPropertyID;
