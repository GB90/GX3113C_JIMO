...
typedef enum  gxav_firmware_id {
	...
	GXAV_FMID_AC3          = 0x003,
	GXAV_FMID_DOLBY        = 0x004,
	GXAV_FMID_DOLBY51      = 0x005,
	GXAV_FMID_DOLBY71      = 0x006,
	GXAV_FMID_DOLBYDCV     = 0x007,
	GXAV_FMID_RA_AAC       = 0x008,
	GXAV_FMID_RA_RA8LBR    = 0x009,
	GXAV_FMID_DRA          = 0x00A,
	GXAV_FMID_MPEG4_AAC    = 0x00B,
	GXAV_FMID_WMA          = 0x00C,
	GXAV_FMID_OGG          = 0x00D,
	GXAV_FMID_PCM          = 0x00E,
...
int  gxav_firmware_exit_static(struct gxav_firmware_info *firmware);
