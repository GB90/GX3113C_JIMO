...
//						 app_exit_to_full_window();
                ...
                case KEY_BLUE://全部删除
                    if(s_pvr_media_map.total == 0)
                        break;
                    #ifdef APP_HD     
                    ret = app_popmsg(340,200,"Delete all file?",POPMSG_TYPE_YESNO);
                    #endif
                    #ifdef APP_SD     
                    ret = app_popmsg(210,150,"Delete all file?",POPMSG_TYPE_YESNO);
                    #endif
                ...
                case KEY_RED:
					{
	                    ...
	                    popdlg_create(&pop);*/
	                     #ifdef APP_HD     
	        			 ret = app_popmsg(340,200,"Delete the file?",POPMSG_TYPE_YESNO);
	        			 #endif
	        			 #ifdef APP_SD     
	        			 ret = app_popmsg(210,150,"Delete the file?",POPMSG_TYPE_YESNO);
	        			 #endif
