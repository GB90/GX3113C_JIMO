...
SIGNAL_HANDLER int win_main_frequency_set_create(const char* widgetname, void *usrdata)
{
    ...
    {
        #ifdef APP_HD
    	GUI_SetProperty("win_main_frequecy_set_title", "img", "mainfreSet.bmp");
    	GUI_SetProperty("win_main_fre_tip_image_exit", "img", "tips_exit.bmp");
    	GUI_SetProperty("win_main_fre_tip_image_ok", "img", "tips_confirm.bmp");
        #endif
    }
    else 
    {
        #ifdef APP_HD
    	GUI_SetProperty("win_main_frequecy_set_title", "img", "mainfreSet_e.bmp");
    	GUI_SetProperty("win_main_fre_tip_image_exit", "img", "tips_exit_e.bmp");
    	GUI_SetProperty("win_main_fre_tip_image_ok", "img", "tips_confirm_e2.bmp");
        #endif
    }
