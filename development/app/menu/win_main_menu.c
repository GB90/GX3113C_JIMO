...
//	GUI_SetProperty(WIDGET_MAIN_IMAGE_FOCUS[BUTTON_TV], "state", "show");
   ...
   // GUI_SetProperty("win_main_menu_text_test","string","测试版本");
    //GUI_SetProperty("win_main_menu_text_test","state","show");
#endif
#endif
#ifdef APP_HD
		char* osd_language=NULL;
...
#endif
#ifdef DVB_AD_TYPE_DIVITONE_FLAG
app_divitone_ads_play("win_main_menu_image_ad",AD_DIVITONE_TYPE_MENU);
#endif

#ifdef DVB_AD_TYPE_DVB_FLAG
	dvb_ads_menu_pic_display("win_main_menu_image_ad");
#endif
	return 0;
}
...
#endif
#ifdef DVB_AD_TYPE_DIVITONE_FLAG
	app_divitone_ads_stop("win_main_menu_image_ad",AD_DIVITONE_TYPE_MENU);
#endif
#ifdef DVB_AD_TYPE_DVB_FLAG
			dvb_ads_hide_menu_pic("win_main_menu_image_ad");
#endif
				...
				switch(g_mainmenubutton)
				{
					case BUTTON_TV:
						...
						else
						{
							...
							GUI_SetInterface("flush", NULL);
#ifdef APP_SD
							app_play_video_window_zoom(84, 140, 250, 186);
#endif
#ifdef APP_HD
					...
					case BUTTON_EPG:
						...
						GUI_SetInterface("flush", NULL);
#ifdef APP_SD
						app_play_video_window_zoom(64, 116, 222, 150);
#endif
#ifdef APP_HD
