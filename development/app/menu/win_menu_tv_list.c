...
#endif
#ifdef DVB_AD_TYPE_DIVITONE_FLAG
app_divitone_ads_play("win_menu_tv_list_image_ad",AD_DIVITONE_TYPE_LIST);
#endif
#ifdef DVB_AD_TYPE_DVB_FLAG
   	dvb_ads_chlist_pic_display("win_menu_tv_list_image_ad");
#endif
	return 0;
}
...
#ifdef DVB_AD_TYPE_DIVITONE_FLAG
app_divitone_ads_stop("win_menu_tv_list_image_ad",AD_DIVITONE_TYPE_LIST);
#endif
#ifdef DVB_AD_TYPE_DVB_FLAG
   	dvb_ads_hide_chlist_pic("win_menu_tv_list_image_ad");
#endif
      	 return 0;
}
