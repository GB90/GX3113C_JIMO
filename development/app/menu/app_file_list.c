...
SIGNAL_HANDLER int app_file_list_create(GuiWidget *widget, void *usrdata)
{
	...
	{
#ifdef HD
		GUI_SetProperty("win_file_list_title", "img", "title_filelist.bmp");
    	GUI_SetProperty("win_file_list_tip_image_exit", "img", "tips_exit.bmp");
    	GUI_SetProperty("wnd_file_list_tip_image_select", "img", "tips_confirm.bmp");
#endif
	}
    else 
	{
#ifdef HD
		GUI_SetProperty("win_file_list_title", "img", "title_filelist_e.bmp");
    	GUI_SetProperty("win_file_list_tip_image_exit", "img", "tips_exit_e.bmp");
    	GUI_SetProperty("wnd_file_list_tip_image_select", "img", "tips_confirm_e2.bmp");
#endif
	}
