...
{	
  ...
  //  	    GUI_SetProperty("win_audio_set_title", "img", "DS_Title_Vedio_set.bmp");
#endif
#ifdef HD	    
    	    GUI_SetProperty("win_audio_set_title", "img", "title_audioset.bmp");
        
    	GUI_SetProperty("win_audio_set_tip_image_exit", "img", "tips_exit.bmp");
#endif
    }
    else 
    {
    ...
    //	    GUI_SetProperty("win_audio_set_title", "img", "DS_Title_Vedio_set_Eng.bmp");
#endif
#ifdef HD
	    GUI_SetProperty("win_audio_set_title", "img", "title_audioset_e.bmp");
        
    	GUI_SetProperty("win_audio_set_tip_image_exit", "img", "tips_exit_e.bmp");
#endif
     }
