...
#endif
#ifdef DVB_AD_TYPE_DIVITONE_FLAG
 app_divitone_ads_play("win_epg_list_ad_image",AD_DIVITONE_TYPE_LIST);
#endif
...
#endif
#ifdef DVB_AD_TYPE_DIVITONE_FLAG
 app_divitone_ads_stop("win_epg_list_ad_image",AD_DIVITONE_TYPE_LIST);
#endif
#ifdef DVB_AD_TYPE_DVB_FLAG
	dvb_ads_hide_epg_pic("win_epg_list_ad_image");
#endif
