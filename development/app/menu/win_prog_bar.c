...
#ifdef DVB_AD_TYPE_DVB_FLAG
	dvb_ads_hide_current_follow_pic("win_prog_bar_ad_image");
#endif
...
#ifdef DVB_AD_TYPE_DVB_FLAG
	dvb_ads_hide_current_follow_pic("win_prog_bar_ad_image");
	dvb_ads_current_follow_pic_display("win_prog_bar_ad_image");
#endif
...
#endif
#ifdef DVB_AD_TYPE_DIVITONE_FLAG
 app_divitone_ads_play("win_prog_bar_ad_image" ,AD_DIVITONE_TYPE_BAR);
#endif
	return 0;
}
...
#ifdef DVB_AD_TYPE_DIVITONE_FLAG
 app_divitone_ads_stop("win_prog_bar_ad_image" ,AD_DIVITONE_TYPE_BAR);
#endif
#ifdef DVB_AD_TYPE_DVB_FLAG
	dvb_ads_hide_current_follow_pic("win_prog_bar_ad_image");
#endif
