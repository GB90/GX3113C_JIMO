...
*/
	...
	GxBus_ConfigSetInt(PLAYER_CONFIG_VIDEO_RESOLUTION, VIDEO_OUTPUT_PAL);
	#endif
#ifdef DVB_AD_TYPE_BY_FLAG
...
//		app_play_i_frame_logo(VideoResolution, LOGO_IFRAME_PATH);
	...
	app_divione_ads_show_av_logo(VideoResolution);
#else
#if (0 == DVB_JPG_LOGO)
...
#ifdef DVB_AD_TYPE_DVB_FLAG
	dvb_ads_show_logo(VideoResolution);
#endif
...
#endif
	GxCore_ThreadCreate("app_idle",&app_idle, app_idle_thread, NULL, 16 * 1024, 10);
	GxCore_Loop();
	return 0;
}
