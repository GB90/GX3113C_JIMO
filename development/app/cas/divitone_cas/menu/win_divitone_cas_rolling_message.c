...
#include "win_divitone_cas_rolling_message.h"
#include "app_divitone_cas_api_pop.h"

void divitone_cas_rolling_message_show(uint8_t byStyle,uint8_t showFlag,char* message)
{
...
int32_t divitone_cas_rolling_message_get_times(void)
{
	int32_t wTimes;  
