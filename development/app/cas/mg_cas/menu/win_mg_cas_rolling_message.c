...
void mg_cas_rolling_message_show(uint8_t byStyle,uint8_t showFlag,char* message)
{
	switch(byStyle)
		{
			case MG_CA_OSD_TOP:
...
int32_t mg_cas_rolling_message_get_times(uint8_t byStyle)
{
	int32_t wTimes=0;  
