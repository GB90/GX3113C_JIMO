...
SIGNAL_HANDLER  int app_by_cas_entitle_create(const char* widgetname, void *usrdata)
{
...
SIGNAL_HANDLER  int app_by_cas_entitle_destroy(const char* widgetname, void *usrdata)
{
	return 0;
}


SIGNAL_HANDLER  int app_by_cas_entitle_listview_key_press(const char* widgetname, void *usrdata)
{
...
SIGNAL_HANDLER  int app_by_cas_entitle_keypress(const char* widgetname, void *usrdata)
{
	GUI_Event *event = NULL;
	event = (GUI_Event *)usrdata;
	if(event->type == GUI_KEYDOWN)
...
SIGNAL_HANDLER  int app_by_cas_entitle_get_count(const char* widgetname, void *usrdata)
{
    get_count.date_type = DVB_CA_ENTITLE_INFO;
    app_cas_api_get_count(&get_count);
...
SIGNAL_HANDLER  int app_by_cas_entitle_get_data(const char* widgetname, void *usrdata)
{
