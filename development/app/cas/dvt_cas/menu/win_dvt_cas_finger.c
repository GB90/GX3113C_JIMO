...
******************************************************************************
* File Name :	win_dvt_cas_finger.c
* Author    : 	zhouhm
...
//#include "win_dvt_cas_api_pop.h"

void dvt_cas_finger_show(uint8_t number,uint8_t showFlag,char* message)
{
	printf("dvt_cas_finger_show number=%d\n",number);
