...
#include "win_qilian_cas_pop.h"
#include "win_qilian_cas_rolling_message.h"
#include "win_qilian_cas_finger.h"
...
void app_qilian_cas_show_ca_prompt(char* context)
{
...
* 
*/
void app_qilian_cas_hide_ca_prompt(void)
{
	app_hide_prompt();
	return;			
}
