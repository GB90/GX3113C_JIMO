...
#include "win_kn_cas_rolling_message.h"

void kn_cas_rolling_message_show(uint8_t byStyle,uint8_t showFlag,char* message)
{
...
int32_t kn_cas_rolling_message_get_times(void)
{
	int32_t wTimes;  
